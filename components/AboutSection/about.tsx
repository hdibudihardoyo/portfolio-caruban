    ...
    <section className="py-20 sm:py-24 px-6 bg-[var(--main-background)]">
      <div className="max-w-5xl mx-auto flex flex-col gap-20">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-14">
          ...
          <motion.div
            variants={getScrollVariants("left", 60)}
            initial="hidden"
            whileInView="visible"
            viewport={scrollViewport}
            className="relative w-full md:w-[380px] h-64 md:h-72 flex-shrink-0"
          >
            <Image
              src="/images5.png"
          ...
          <motion.div
            variants={getScrollVariants("right", 60)}
            initial="hidden"
            whileInView="visible"
            viewport={scrollViewport}
            className="flex flex-col gap-5 text-[var(--color-primary)] text-justify leading-relaxed"
          >
            <p>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          {/* Mission — slide from bottom with delay */}
          <motion.div
            variants={getScrollVariants("up")}
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <ul className="flex flex-col gap-3 text-[var(--color-primary)]">
              <li className="flex gap-3">
                <span className="text-[var(--secondary-accent)] font-bold">01</span>
                <span>{t("Mission1")}</span>
              </li>
              <li className="flex gap-3">
                <span className="text-[var(--secondary-accent)] font-bold">02</span>
                <span>{t("Mission2")}</span>
              </li>
              <li className="flex gap-3">
                <span className="text-[var(--secondary-accent)] font-bold">03</span>
