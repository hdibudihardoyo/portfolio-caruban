      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-[var(--border)] bg-white/90 text-[var(--brand-dark)] shadow-sm transition-all hover:bg-white lg:hidden"
          >
            {menuOpen ? (
              <X className="h-5 w-5" />
            ) : (
          ...
          <Link
            ...
            className="hidden lg:inline-flex bg-[var(--brand-dark)] hover:bg-[var(--primary)] text-white text-[10px] font-black uppercase tracking-widest py-2.5 px-5 rounded-xl transition-all shadow-lg active:scale-95 whitespace-nowrap"
          >
            Hubungi Kami
          </Link>
        </div>
